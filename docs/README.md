...
Documentation for Igne - a fast, extensible knowledge base application with Obsidian plugin compatibility.

For project overview, features, and quick start, see the **[main README](../README.md)**.
